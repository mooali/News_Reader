...
public class News_Feed_Switzerland extends Connection implements News  {
    ...
    String swissApi = "http://newsapi.org/v2/top-headlines?country=ch&apiKey=1c488ff068774a759c2b59ba4f93e146";

    private static StringBuffer responseContent;
    private Connection connection = new Connection();
    public int articleNumber;

    public News_Feed_Switzerland(){
        this.connection.connect(swissApi);
